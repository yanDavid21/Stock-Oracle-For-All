...
class BaseCategorizedSchedule(BaseSchedule):
    ...
    def __init__(
        ...
        super().__init__(provider, cron_schedule, job, default_status, execution_timezone)
...
class BaseCategorizedScheduleFactory(ABC):
    ...
    @abstractmethod
    def create_schedule(self, category: StrEnum, cron_schedule: str, **kwargs) -> ScheduleDefinition:
        pass
